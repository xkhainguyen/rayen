...
class CustomDataset(Dataset):
    def __init__(
        self, all_x, all_y, all_Pobj, all_qobj, all_robj, all_times_s, all_costs
    ):
...
def createProjectionDataset(num_samples, cs, bbox_half_side):
    ...
    my_dataset = CustomDataset(
        all_x, all_y, all_Pobj, all_qobj, all_robj, all_times_s, all_costs
    )
...
def getCorridorDatasets(dimension):
    ...
    my_dataset_out_dist = CustomDataset(
        all_x_out_dist,
        all_y_out_dist,
        all_Pobj_out_dist,
        all_qobj_out_dist,
